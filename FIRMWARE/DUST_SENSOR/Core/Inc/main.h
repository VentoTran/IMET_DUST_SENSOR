...
#define FLH_CS_Pin GPIO_PIN_4
#define FLH_CS_GPIO_Port GPIOA
#define FLH_WP_Pin GPIO_PIN_4
#define FLH_WP_GPIO_Port GPIOC
#define FLH_RST_Pin GPIO_PIN_5
#define FLH_RST_GPIO_Port GPIOC
...
#define CTR_PWR_Pin GPIO_PIN_4
#define CTR_PWR_GPIO_Port GPIOB
#define CTR_GND_Pin GPIO_PIN_5
#define CTR_GND_GPIO_Port GPIOB
