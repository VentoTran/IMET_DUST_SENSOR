...
FRESULT	create_directory(char *directory){
		FRESULT	fr;
		// FILINFO fno;
		// 	char dir[128]={0}; 
		// sprintf(dir,"//%s",directory);
		// i = strlen(dir);
		// fr = f_stat(dir, &fno);	//Check Directory Exist
		// if (fr == FR_OK){
		// 	printf("Directory Exist. Don't Create Directory\n");
		// 	return FR_EXIST;
		// }
		// else {
		// 	printf("log: Directory No Exist. Create Directory");
		// 	fr = f_mkdir(directory);
		// 	if(fr == FR_OK)printf(" => create OK\n");
...
//	memcpy(directory_buffer,directory,dir_len);
	// sprintf(directory_buffer,"/%s",filename);
	printf("Dir = %s\n",filename);
